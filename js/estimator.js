// estimator.js - single source for service rates and addons
...
// Build or update addons UI when service changes
  ...
  addons.forEach(addon => {
    ...
    div.innerHTML = `
      <div class="form-check">
        ...
        <label class="form-check-label" for="${addon.id}">${addon.name} <span class="addon-price">+₹${addon.price}/${addon.unit}</span></label>
      </div>
    `;
